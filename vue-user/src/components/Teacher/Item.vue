<template>
    <tr>
        ...
        <td v-if="isEdited==false">{{ teacher.password }}</td>
        ...
        <!-- 
             1.隐藏上面的代码 
             2.显示下面的代码
             3.同时输入框： <el-input type="text" v-model.number="teacher.age" class="w-50"></el-input>    显示
             4.以此进行编辑修改学生信息 
        -->
            
         <td v-if="isEdited==true">
                <el-input type="text" v-model.number="teacher.password" class="w-50"></el-input> <!-- class="w-50"使输入框变成原来的一半宽度 -->
